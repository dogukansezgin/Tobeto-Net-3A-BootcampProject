...
public class EfRepositoryBase<TEntity, TEntityId, TContext> : ISyncRepository<TEntity, TEntityId>, IAsyncRepository<TEntity, TEntityId>
    ...
    where TContext : DbContext
{
    ...
    // Async
    public async Task<IQueryable<TEntity>> AsyncQuery() => Context.Set<TEntity>();
